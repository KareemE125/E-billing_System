...
export class ElectricityComponent implements OnInit {
  ...
  infoList: CommonBill[] = [
    {
      id: '1', year: 2021, month: 9, total: 500, isPaid: false, penalty: 20, units: 890, paymentDate: "Not Yet", paymentMethod: null
    },
    {
      id: '1', year: 2022, month: 1, total: 800, isPaid: true, penalty: 0, units: 0, paymentDate: "Not Yet", paymentMethod: null
    },
    {
      id: '1', year: 2021, month: 6, total: 1200, isPaid: false, penalty: 10, units: 555, paymentDate: "Not Yet", paymentMethod: null
    },
    {
      id: '1', year: 2023, month: 2, total: 1500, isPaid: true, penalty: 30, units: 230, paymentDate: "Not Yet", paymentMethod: null
    }
  ];
